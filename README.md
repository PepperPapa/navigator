...
# 5.台体控制命令封装库的设计  
  封装如下测试台体控制命令：
  - :dut-set uaon 打开A相电压
  - :dut-set uaoff 关闭A相电压
  - :dut-set ubon 打开B相电压
  - :dut-set uboff 关闭B相电压
  - :dut-set ucon 打开C相电压
  - :dut-set ucoff 关闭C相电压
  - :dut-set iaon 打开A相电流
  - :dut-set iaoff 关闭A相电流
  - :dut-set ibon 打开B相电流
  - :dut-set iboff 关闭B相电流
  - :dut-set icon 打开C相电流
  - :dut-set icoff 关闭C相电流
  - :dut-set uion 打开三相电压和电流
  - :dut-set uioff 关闭三相电压和电流
  - :dut-set uon 打开三相电压
  - :dut-set uoff 关闭三相电压
  - :dut-set ion 打开三相电流
  - :dut-set ioff 关闭三相电流
